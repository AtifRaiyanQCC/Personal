...
Iterator insert(List &list, Iterator itr, const Profession &d)     // adds a new node before the node pointed to by the iterator ie insert(list, itr, Profession("N/A", 100));
{                                                                  // 500 -> 100, 500
...
Iterator erase(List &list, Iterator itr)                           // removes the node before the node pointed to by the iterator. ie erase(list, itr);
{                                                                  // 100, 500 -> 500
    if(itr.current == nullptr) { return itr; }              
